...
namespace ChessGameAPI.Migrations
{
    ...
    [Migration("20181007022332_UpdatedGame")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChessGameAPI.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ChessGameAPI.Models.Message", b =>
                {
                    b.HasOne("ChessGameAPI.Models.User", "Recipient")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ChessGameAPI.Models.User", "Sender")
